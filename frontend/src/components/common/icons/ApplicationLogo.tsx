...
export const ApplicationLogo: React.FC<ApplicationLogoProps> = ({
    ...
    return (
        <svg width={pixelSize} height={pixelSize} viewBox="0 0 256 256" fill="none">
            ...
            <circle cx="128" cy="128" r="115" fill="none" stroke="url(#borderGradient)" strokeWidth="12"/>
            <line x1="70" y1="90" x2="128" y2="128" stroke={color1} strokeWidth="6" opacity="0.5"/>
            <line x1="186" y1="90" x2="128" y2="128" stroke={color2} strokeWidth="6" opacity="0.5"/>
            <line x1="70" y1="166" x2="128" y2="128" stroke={color3} strokeWidth="6" opacity="0.5"/>
            <line x1="186" y1="166" x2="128" y2="128" stroke={color1} strokeWidth="6" opacity="0.5"/>
            <line x1="70" y1="90" x2="186" y2="90" stroke={color2} strokeWidth="6" opacity="0.3"/>
            <line x1="70" y1="166" x2="186" y2="166" stroke={color3} strokeWidth="6" opacity="0.3"/>
