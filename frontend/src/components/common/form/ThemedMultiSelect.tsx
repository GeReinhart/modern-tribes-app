...
export const ThemedMultiSelect: React.FC<ThemedMultiSelectProps> = ({
    ...
    return (
        <div className="w-full" ref={containerRef}>
            {label && (
                <label className="block text-sm font-medium mb-1" style={{ color: theme.colors[variant] }}>
                    {label}
                </label>
            )}
                                ...
                                >
                                    ...
                                    {!disabled && (
                                        <button
                                            ...
                                            style={{ background: 'none', border: 'none', color: theme.colors[variant], cursor: 'pointer' }}
                                        >
                                            ×
                                        </button>
                                    )}
