...
export const LabelSelector: React.FC<LabelSelectorProps> = ({
    ...
    const showCreate = inputValue.trim() && !suggestions.some(
            ...
            <div ref={containerRef} style={{ position: 'relative' }}>
                ...
                {open && (filtered.length > 0 || showCreate) && (
                    <div style={dropdownStyle}>
                        ...
                        {showCreate && (
                            <div
                                style={{ ...optionStyle, color: theme.colors.primary, fontStyle: 'italic' }}
                                onMouseDown={(e) => { e.preventDefault(); addLabel(inputValue); }}
                                onMouseEnter={e => { e.currentTarget.style.backgroundColor = `${theme.colors.primary}10`; }}
                                onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; }}
                            >
