...
import { RowActionsMenu } from '@/components/common/menu/RowActionsMenu';
...
function NotificationsAdminContent(): React.ReactElement {
    ...
    return (
        ...
        >
            <ThemedCard>
                <ThemedText variant="primary" as="h2">{t('admin.notifications.title')}</ThemedText>
...
export function NotificationsAdminPage(): React.ReactElement {
    return (
