...
const CreateProjectPageContent: React.FC = () => {
    ...
    const { createProjectWithDocument, loading } = useProjectWithDocumentMutations();
            ...
            <form onSubmit={handleSubmit}>
                <div style={formContainerStyle}>
                    ...
                    <div style={formActionsStyle}>
                        <ThemedButton variant="secondary" onClick={() => navigate(`/app/tribes/${tribeId}`)} disabled={submitting}>
                            {t('common.cancel')}
                        </ThemedButton>
...
export const CreateProjectPage: React.FC = () => (
    <ThemeProvider defaultTheme="default"><CreateProjectPageContent /></ThemeProvider>
);
