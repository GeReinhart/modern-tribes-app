...
const EditProjectDocumentPageContent: React.FC = () => {
    ...
    const menuActions = useMemo((): MenuAction[] => [
        { icon: 'x', label: t('common.cancel'), onClick: () => navigate(`/app/tribes/${tribeId}/projects/${projectId}`) },
...
export const EditProjectDocumentPage: React.FC = () => (
    <ThemeProvider defaultTheme="default"><EditProjectDocumentPageContent /></ThemeProvider>
);
