import { GithubIcon } from '@/platform/core/layout/themes/icons/GithubIcon.tsx';
...
const STACK = [
  ...
  {
    layer: 'Database',
    tech: 'PostgreSQL 16 (JSONB, full-text search, Alembic)',
  },
  {
    layer: 'Frontend',
    tech: 'React 18 · TypeScript · Vite · Tailwind CSS · PWA',
  },
...
const APP_FEATURES = [
  ...
  {
    name: 'Kanban',
    desc: 'Columnar board (up to 4 columns), card notes, theme-coloured columns',
  },
];
