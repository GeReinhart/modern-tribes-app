  ...
  return (
    <>
      ...
      >
              ...
              <>
                <button
                  ...
                  style={{
                    background: 'none',
                    border: 'none',
                    cursor: isFirstCol ? 'default' : 'pointer',
                    opacity: isFirstCol ? 0.2 : 1,
                    padding: '0 1px',
                    flexShrink: 0,
                    display: 'flex',
                    alignItems: 'center',
                ...
                <button
                  ...
                  style={{
                    background: 'none',
                    border: 'none',
                    cursor: isLastCol ? 'default' : 'pointer',
                    opacity: isLastCol ? 0.2 : 1,
                    padding: '0 1px',
                    flexShrink: 0,
                    display: 'flex',
                    alignItems: 'center',
        ...
        {expanded && <KanbanCardBody card={card} boardLabels={boardLabels} />}
      </div>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              >
                {t('features.kanban.archiveCardTitle')}
              </span>
            </div>
            <p
              style={{
