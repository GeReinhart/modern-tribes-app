...
export const BOOKMARK_COLOR_PRESETS: BookmarkColorPreset[] = [
    ...
    { id: 'cornflower',  label: 'Cornflower',  background: '#dce9ff', text: '#2a4e8c' },
    { id: 'dodger',      label: 'Dodger Blue', background: '#d0e8ff', text: '#114b82' },
    // Purples — alt_01 secondary, alt_03
    { id: 'periwinkle',  label: 'Periwinkle',  background: '#e4e0ff', text: '#3e2d9c' },
    ...
    { id: 'aquamarine',  label: 'Aquamarine',  background: '#d0f4e8', text: '#244a3d' },
    { id: 'turquoise',   label: 'Turquoise',   background: '#d0f4f2', text: '#174038' },
    ...
    { id: 'goldenrod',   label: 'Goldenrod',   background: '#fef3d5', text: '#7a5200' },
    // Pinks — alt_07
