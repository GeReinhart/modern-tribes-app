...
export async function getMyTasks(filters: MyTasksFilters = {}): Promise<MyTasksResponse> {
    return apiService.get<MyTasksResponse>(`/query/my-tasks${buildQuery(filters)}`);
}
