...
import { appConfigService } from '@/app/platform/core/app-config/app-config.service.ts';
import { AppConfigCreate, AppConfigEntry } from '@/app/platform/core/app-config/app-config.types.ts';
...
function useAdminConfig() {
  ...
  const { loading, error, execute } = apiHooks<AppConfigEntry[]>();
