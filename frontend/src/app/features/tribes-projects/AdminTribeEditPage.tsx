...
import {
  ...
  useTribeMutations,
  useTribeProjects,
} from '@/app/features/tribes-projects/tribes/useTribes.ts';
import { positionService } from '@/app/features/tribes-projects/positions/position.service.ts';
import { tribeService } from '@/app/features/tribes-projects/tribes/tribe.service.ts';
...
import {
  ...
  TribeUpdate,
} from '@/app/features/tribes-projects/tribes/tribe.types.ts';
...
export const AdminTribeEditPage: React.FC = () => (
