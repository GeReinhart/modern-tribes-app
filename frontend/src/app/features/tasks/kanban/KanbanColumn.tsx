...
const KanbanColumn: React.FC<Props> = ({
  ...
  const handleAddCard = async (e: React.FormEvent) => {
    ...
    await onCreateCard({
      ...
      assigned_person_id: autoAssignee,
    });
    setNewCardTitle('');
  };
    ...
    >
      ...
      >
        ...
        {canEdit && configuring && canDelete && (
          ...
          >
            <ThemedSvgIcon name="x" color={theme.colors.danger} size={15} />
          </button>
        )}
      </div>
      ...
      <div style={{ flex: 1, minHeight: '40px' }}>
        {visibleActive.map((card, idx) => (
          <KanbanCardComponent
            ...
            isLastCol={isLast}
            isFirstInCol={idx === 0}
            isLastInCol={idx === visibleActive.length - 1}
      ...
      <ThemedConfirmDialog
        ...
        message={t('features.kanban.deleteColumnMessage', {
          name: column.name,
        })}
