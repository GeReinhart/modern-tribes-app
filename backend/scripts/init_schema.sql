...
-- Reflects full schema (alembic revision 002)
...
CREATE UNIQUE INDEX IF NOT EXISTS labels_name_global_unique ON labels (name);
...
-- project_document_id FK removed; features re-attach via migration
