...
FEATURE = "../../../../features/platform/core/app_config/list_app_config.feature"


@scenario(FEATURE, "GET /app-config/ as admin — configuration entries are returned")
def test_list_admin():
    pass


@scenario(FEATURE, "GET /app-config/ as a viewer — 403 error")
...
def admin_client():
    ...
    with (
        ...
        patch("app.platform.core.app_config.router.get_all_documents",
