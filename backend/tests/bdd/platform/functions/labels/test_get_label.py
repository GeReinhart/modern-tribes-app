...
FEATURE = "../../../../features/platform/functions/labels/get_label.feature"
...
@scenario(FEATURE, "GET /labels/0010 as admin — label is returned")
def test_get_label_admin():
    pass


@scenario(FEATURE, "GET /labels/0010 as a viewer — 403 error")
def test_get_label_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.platform.functions.labels.router.get_document_by_id",
              new=AsyncMock(return_value=_FAKE_LABEL)),
    ):
