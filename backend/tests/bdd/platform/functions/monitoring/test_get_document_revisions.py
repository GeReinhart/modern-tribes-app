...
FEATURE = "../../../../features/platform/functions/monitoring/get_document_revisions.feature"
...
@scenario(FEATURE, "GET /monitoring/documents/0010/revisions as admin — revisions are returned")
def test_get_document_revisions_admin():
    pass

@scenario(FEATURE, "GET /monitoring/documents/0010/revisions as a viewer — 403 error")
def test_get_document_revisions_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.platform.functions.monitoring.router.get_database",
              return_value=_make_mock_pool(fetch_return=[_FAKE_REVISION])),
    ):
