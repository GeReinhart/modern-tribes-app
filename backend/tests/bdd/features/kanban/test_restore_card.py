...
FEATURE = "../../../features/features/kanban/restore_card.feature"

@scenario(FEATURE, "POST /kanban/cards/0010/restore as admin — card is restored")
def test_restore_card_admin():
    pass

@scenario(FEATURE, "POST /kanban/cards/0010/restore as a viewer without project access — 403 error")
def test_restore_card_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tasks.kanban.repository.restore_card", new=AsyncMock(return_value=None)),
    ):
