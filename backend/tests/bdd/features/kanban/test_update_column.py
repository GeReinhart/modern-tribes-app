...
@scenario(FEATURE, "PATCH /kanban/columns/0010 as a viewer without project access — 403 error")
def test_update_column_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tasks.kanban.repository.update_column",
              new=AsyncMock(return_value={"id": "col1", "name": "In Progress", "position": 1})),
    ):
