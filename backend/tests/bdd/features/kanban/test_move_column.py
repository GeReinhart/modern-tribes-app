...
@scenario(FEATURE, "POST /kanban/columns/0010/move as a viewer without project access — 403 error")
def test_move_column_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tasks.kanban.repository.fetch_column",
              new=AsyncMock(return_value={"id": "00000000-0000-0000-0000-000000000010", "name": "In Progress", "position": 2, "feature_instance_id": "fi-id"})),
        ...
        patch("app.features.tasks.kanban.repository.fetch_columns_sorted",
              new=AsyncMock(return_value=[{"id": "c1", "name": "To Do", "position": 1}, {"id": "00000000-0000-0000-0000-000000000010", "name": "In Progress", "position": 2}, {"id": "c3", "name": "Done", "position": 3}])),
        patch("app.features.tasks.kanban.repository.swap_column_positions", new=AsyncMock(return_value=None)),
    ):
