...
FEATURE = "../../../features/features/kanban/update_card.feature"

@scenario(FEATURE, "PATCH /kanban/cards/0010 as admin — the card is updated")
def test_update_card_admin():
    pass

@scenario(FEATURE, "PATCH /kanban/cards/0010 as a viewer without project access — 403 error")
def test_update_card_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tasks.kanban.repository.update_card_fields", new=AsyncMock(return_value=None)),
    ):
