...
FEATURE = "../../../features/features/kanban/create_card.feature"

@scenario(FEATURE, "POST /kanban/cards as admin — the card is created")
def test_create_card_admin():
    pass

@scenario(FEATURE, "POST /kanban/cards as a viewer without project access — 403 error")
def test_create_card_forbidden():
    pass
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tasks.kanban.repository.insert_card",
