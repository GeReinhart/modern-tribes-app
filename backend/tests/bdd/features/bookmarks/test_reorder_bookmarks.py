...
FEATURE = "../../../features/features/bookmarks/reorder_bookmarks.feature"

@scenario(FEATURE, "PUT /bookmarks/order as viewer — bookmarks are reordered")
def test_reorder_bookmarks_viewer():
    pass

@scenario(FEATURE, "PUT /bookmarks/order as a user with no app access — 403 error")
def test_reorder_bookmarks_forbidden():
    pass
