...
FEATURE = "../../../features/features/bookmarks/remove_bookmark.feature"

@scenario(FEATURE, "DELETE /bookmarks/0010 as viewer — bookmark is removed")
def test_remove_bookmark_viewer():
    pass

@scenario(FEATURE, "DELETE /bookmarks/0010 as a user with no app access — 403 error")
