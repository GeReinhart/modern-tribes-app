...
FEATURE = "../../../features/features/bookmarks/update_bookmark.feature"

@scenario(FEATURE, "PUT /bookmarks/0010 with valid body as viewer — the bookmark is updated")
def test_update_bookmark_viewer():
    pass

@scenario(FEATURE, "PUT /bookmarks/0010 as a user with no app access — 403 error")
def test_update_bookmark_forbidden():
    pass
