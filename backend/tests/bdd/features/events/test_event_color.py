...
FEATURE = "../../../features/features/events/event_color.feature"


@scenario(FEATURE, "POST /events with a chosen color — the event is created with that color")
def test_event_color_create_with_color():
    pass


@scenario(FEATURE, "POST /events without a color — a default color is applied")
def test_event_color_create_default():
    pass


@scenario(FEATURE, "PATCH /events/{id} — change the color of an existing event")
def test_event_color_patch():
    pass
