...
@scenario(FEATURE, "PATCH /todo-items/0010 as a viewer without project access — 403 error")
def test_update_todo_forbidden():
    pass

@pytest.fixture
def admin_client():
    pool = _make_mock_pool({'feature_instance_id': '00000000-0000-0000-0000-000000000100'}, {'project_id': '00000000-0000-0000-0000-000000000200'})
    ...
    with (
        ...
        patch("app.features.tasks.todo_list.repository.update_todo_item_basic", new=AsyncMock(return_value=None)),
        patch("app.features.tasks.todo_list.repository.fetch_todo_item",
...
def non_admin_client():
    pool = _make_mock_pool(
        {"feature_instance_id": "00000000-0000-0000-0000-000000000100"},
