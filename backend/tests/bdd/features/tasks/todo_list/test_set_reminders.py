...
FEATURE = "../../../../features/features/tasks/todo_list/set_reminders.feature"
...
@scenario(FEATURE, "Setting a push reminder with an assignee notifies creator and assignee")
def test_set_reminders_notifies_creator_and_assignee():
    pass
