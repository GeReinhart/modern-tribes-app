...
FEATURE = "../../../../../features/features/guitar/song/sections/archive_section.feature"


@scenario(FEATURE, "Manager removes a section — it is archived")
def test_archive_section():
    pass
