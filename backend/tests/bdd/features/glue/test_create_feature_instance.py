...
FEATURE = "../../../features/features/glue/create_feature_instance.feature"

@scenario(FEATURE, "POST /feature-instances/projects/0100/features as admin — the instance is created")
def test_create_feature_instance_admin():
    pass

@scenario(FEATURE, "POST /feature-instances/projects/0100/features as a viewer without project access — 403 error")
