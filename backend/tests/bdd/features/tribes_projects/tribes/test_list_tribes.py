...
FEATURE = "../../../../features/features/tribes_projects/tribes/list_tribes.feature"


@scenario(FEATURE, "GET /tribes/ as admin — tribes are returned")
def test_list_admin():
    pass


@scenario(FEATURE, "GET /tribes/ as a viewer — 403 error")
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tribes_projects.tribes.router.get_all_documents",
