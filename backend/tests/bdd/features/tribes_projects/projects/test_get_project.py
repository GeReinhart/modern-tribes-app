...
FEATURE = "../../../../features/features/tribes_projects/projects/get_project.feature"

_DT = datetime(2024, 1, 1)

_FAKE = {"id": "00000000-0000-0000-0000-000000000010", "name": "Website Redesign", "url_param_id": "abc456", "document_id": None, "status": "active", "created_at": _DT, "updated_at": _DT, "created_by": None, "updated_by": None}


@scenario(FEATURE, "GET /projects/0010 as admin — project is returned")
def test_get_admin():
    pass


@scenario(FEATURE, "GET /projects/0010 as a viewer — 403 error")
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tribes_projects.projects.router.get_document_by_id",
