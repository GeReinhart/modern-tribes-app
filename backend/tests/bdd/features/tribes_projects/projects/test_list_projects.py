...
FEATURE = "../../../../features/features/tribes_projects/projects/list_projects.feature"


@scenario(FEATURE, "GET /projects/ as admin — projects are returned")
def test_list_admin():
    pass


@scenario(FEATURE, "GET /projects/ as a viewer — 403 error")
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tribes_projects.projects.router.get_all_documents",
