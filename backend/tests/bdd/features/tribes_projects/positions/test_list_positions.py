...
FEATURE = "../../../../features/features/tribes_projects/positions/list_positions.feature"


@scenario(FEATURE, "GET /positions/ as admin — positions are returned")
def test_list_admin():
    pass


@scenario(FEATURE, "GET /positions/ as a viewer — 403 error")
...
def admin_client():
    ...
    with (
        ...
        patch("app.features.tribes_projects.positions.router.get_all_documents",
