Feature: Dashboard planning — journal summary for a given day
  ...
  Scenario: GET /journal-blocks/accessible?date=2026-07-01 as admin — returns journal tabs with block count for the day
  ...
  @error_case
  Scenario: GET /journal-blocks/accessible as viewer without app access — 403 error
