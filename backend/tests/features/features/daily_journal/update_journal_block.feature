Feature: Update a journal block
  As a project member
  I want to edit the content of a journal block
  So that I can correct or enrich a note
  ...
  Scenario: PATCH /journal-blocks/{id} as admin — block content is updated
    ...
    And the documents table contains:
      | id   | content_html      |
      | 0101 | <p>Updated note</p> |

  @error_case
  Scenario: PATCH /journal-blocks/{id} as viewer without project access — 403 error
    Given I am authenticated as a regular user: user.id 0002
    When I PATCH /api/features/daily-journal/blocks/0011 with body:
      """
      {"content_html": "<p>Should not update</p>"}
      """
