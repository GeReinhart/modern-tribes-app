Feature: Duplicate a whole song
  ...
  Background:
    ...
    And the guitar_songs_layout_column_blocks table contains:
      ...
      | 0761 | 0750      | 0200    | 2        | sections   | Twinkle     |                                                                                 | active |
      | 0762 | 0750      | 0200    | 3        | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000300"}] | active |
  ...
  Scenario: POST duplicate on a song — a new song is created with the same content, titled "<title> - COPIE"
    ...
    And the guitar_songs_layout_column_blocks table contains:
      ...
      | sections   | Twinkle     |                                                                                 | active |
      | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000300"}] | active |
      | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000300"}] | active |
