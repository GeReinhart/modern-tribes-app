Feature: Create a guitar song
  ...
  Scenario: POST a song with a chord diagram style and size — they are saved
    ...
    When I POST /api/features/tasks/guitar-songs/projects/0020/songs with body:
      """
      {"title": "Zombie", "author": "The Cranberries", "tempo_bpm": 84, "beats_per_bar": 4, "chord_diagram_style": "simple", "chord_diagram_size": "xl"}
      """
    Then the response status code is 201
    And the response body includes:
      """
  ...
  Scenario: POST a song with a copy_from_song_id — content and layout are copied, but title/author stay the request's own
    ...
    And the guitar_songs table contains:
      ...
      | 0203 | 0020       | Wonderwall | Oasis  | 87        | 4              | 2    | simple               | l               | active |
    ...
    And the guitar_songs_layout_column_blocks table contains:
      | id   | column_id | song_id | position | block_type | lyrics_text | chords                                            | status |
      | 0761 | 0751      | 0203    | 1        | title      |             |                                                   | active |
      | 0762 | 0751      | 0203    | 2        | sections   | Twinkle     |                                                   | active |
      | 0763 | 0751      | 0203    | 3        | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000301"}] | active |
    When I POST /api/features/tasks/guitar-songs/projects/0020/songs with body:
      """
    ...
    And the response body includes:
      """
      {
        ...
        "capo": 2,
        "chord_diagram_style": "simple",
        "chord_diagram_size": "l"
      }
      """
    And the guitar_songs table contains:
      | project_id | title              | author  | tempo_bpm | beats_per_bar | capo | chord_diagram_style | chord_diagram_size | status |
      | 0020       | Wonderwall         | Oasis   | 87        | 4              | 2    | simple               | l               | active |
      | 0020       | Wonderwall - Cover | My Band | 87        | 4              | 2    | simple               | l               | active |
    And the guitar_songs_videos table contains:
      | title       | url                            | position | status |
      | Live at BBC | https://example.com/video.mp4 | 1        | active |
      | Live at BBC | https://example.com/video.mp4 | 1        | active |
    And the guitar_songs_layout_column_blocks table contains:
      | block_type | lyrics_text | chords                                            | status |
      | title      |             |                                                   | active |
      | title      |             |                                                   | active |
      | sections   | Twinkle     |                                                   | active |
      | sections   | Twinkle     |                                                   | active |
      | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000301"}] | active |
      | chords     |             | [{"comment": "Play softly", "chord_id": "00000000-0000-0000-0000-000000000301"}] | active |
