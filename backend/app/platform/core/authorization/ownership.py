...
from app.platform.core.utils.db_helpers import get_document_by_id, resolve_url_param_id
...
async def check_own_tribe_position_or_admin(
    tribe_id: str, current_user: dict, pool, required_position: Optional[str] = None
) -> None:
    ...
    if not all_positions:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN, detail="You are not a member of this tribe."
        )
