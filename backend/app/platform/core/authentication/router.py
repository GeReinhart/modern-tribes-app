...
from app.platform.tools.mail.email import magic_link_html
from app.platform.core.authentication import repository as auth_repo
from app.platform.core.authentication import service as auth_service
from app.platform.core.authentication.models import (
    MagicLinkRequest,
    MagicLinkResponse,
    RefreshRequest,
    RefreshResponse,
...
from app.platform.core.authentication.security import create_magic_token
